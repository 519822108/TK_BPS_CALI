...
{
public:
    CtlCan(int type=VCI_USBCAN_2E_U,int index=0,int cindex=0,int port=0);
    ...
    int send_one_msg(unsigned int ID,char len,char *data,isExtFram frame=ext_frame,isRomete romete=frame_data,sendType type=send_nomal);
